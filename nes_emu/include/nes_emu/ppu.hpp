...
class PPU {
 private:
    ...
    static const std::size_t EXTRA_MAX_SCANLINE_SPRITES = 64;
    ...
    std::array<NES_Byte, EXTRA_MAX_SCANLINE_SPRITES> scanline_sprites;
    /// Number of valid entries in scanline_sprites.
    std::size_t scanline_sprite_count;
    std::size_t scanline_max_sprites;
    ...
    std::array<SpriteRow, EXTRA_MAX_SCANLINE_SPRITES> scanline_sprite_rows;
 ...
 public:
    ...
    PPU() :
        ...
        scanline_max_sprites(MAX_SCANLINE_SPRITES),
